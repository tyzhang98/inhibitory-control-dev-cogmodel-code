...
# 数据加载和预处理函数
load_and_prepare_data <- function(stroop_path = "/Users/zhangtongyi/Desktop/博士论文/1.博士论文计算建模研究/2.一般分析/1.Gonogo和Stroop比-主站点前测/Stroop-baseline.xlsx",
                                  gonogo_path = "/Users/zhangtongyi/Desktop/博士论文/1.博士论文计算建模研究/2.一般分析/1.Gonogo和Stroop比-主站点前测/Gonogo-baseline.xlsx") {
...
compute_gam_derivatives <- function(gam_model, data, age_range = NULL,
  ...
  n_obs <- nrow(data)
  n_bootstrap_actual <- min(n_bootstrap, 10000)
...
create_comprehensive_plots <- function(gam_results, successful_metrics, data_final) {
  ...
  p1 <- ggplot(plot_data, aes(x = age, y = predictions)) +
    ...
    {if (!is.na(stroop_incongruent_latest) && !is.na(nogo_acc_latest)) {
      ...
      list(
        geom_vline(xintercept = nogo_acc_latest,
                   color = "#006d2c", linetype = "dashed",
                   linewidth = 0.8, alpha = 0.8),
        annotate("text", x = nogo_acc_latest, y = 1.6,
                 label = paste0("NoGo准确率: ", round(nogo_acc_latest, 1), "岁"),
                 color = "#006d2c", fontface = "bold", size = 3.5,
                 hjust = 0.5)
      )
    } else {
...
save_comprehensive_results <- function(gam_results, data_final, successful_metrics,
                                       ...
                                       completion_stats, plots, output_dir = "/Users/zhangtongyi/Desktop/博士论文/1.博士论文计算建模研究/2.一般分析/1.Gonogo和Stroop比-主站点前测/output") {
...
# 主分析函数
main_gam_analysis <- function(stroop_path = "/Users/zhangtongyi/Desktop/博士论文/1.博士论文计算建模研究/2.一般分析/1.Gonogo和Stroop比-主站点前测/Stroop-baseline.xlsx",
                              gonogo_path = "/Users/zhangtongyi/Desktop/博士论文/1.博士论文计算建模研究/2.一般分析/1.Gonogo和Stroop比-主站点前测/Gonogo-baseline.xlsx") {
  ...
  for (task_metric in unique(data_final$task_metric)) {
    ...
    if (!is.null(gam_model)) {
      # 计算导数和统计
      results <- compute_gam_derivatives(gam_model, metric_data, age_range, n_bootstrap = 10000)
...
# 保存核心指标图形函数
save_core_plots <- function(core_plots, output_dir = "/Users/zhangtongyi/Desktop/博士论文/1.博士论文计算建模研究/2.一般分析/1.Gonogo和Stroop比-主站点前测/output") {
...
# 执行完整分析并生成报告
run_complete_analysis <- function(stroop_path = "/Users/zhangtongyi/Desktop/博士论文/1.博士论文计算建模研究/2.一般分析/1.Gonogo和Stroop比-主站点前测/Stroop-baseline.xlsx",
                                  gonogo_path = "/Users/zhangtongyi/Desktop/博士论文/1.博士论文计算建模研究/2.一般分析/1.Gonogo和Stroop比-主站点前测/Gonogo-baseline.xlsx",
                                  output_dir = "/Users/zhangtongyi/Desktop/博士论文/1.博士论文计算建模研究/2.一般分析/1.Gonogo和Stroop比-主站点前测/output") {
...
# 检查文件是否存在
stroop_file <- "/Users/zhangtongyi/Desktop/博士论文/1.博士论文计算建模研究/2.一般分析/1.Gonogo和Stroop比-主站点前测/Stroop-baseline.xlsx"
gonogo_file <- "/Users/zhangtongyi/Desktop/博士论文/1.博士论文计算建模研究/2.一般分析/1.Gonogo和Stroop比-主站点前测/Gonogo-baseline.xlsx"
...
# 扩展的完整分析函数
run_extended_complete_analysis <- function(stroop_path = "/Users/zhangtongyi/Desktop/博士论文/1.博士论文计算建模研究/2.一般分析/1.Gonogo和Stroop比-主站点前测/Stroop-baseline.xlsx",
                                           gonogo_path = "/Users/zhangtongyi/Desktop/博士论文/1.博士论文计算建模研究/2.一般分析/1.Gonogo和Stroop比-主站点前测/Gonogo-baseline.xlsx",
                                           output_dir = "/Users/zhangtongyi/Desktop/博士论文/1.博士论文计算建模研究/2.一般分析/1.Gonogo和Stroop比-主站点前测/output") {
